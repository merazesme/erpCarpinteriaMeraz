		              ...
		              <div class="card">
		                  <div class="card-body">
							  ...
							  <ul class="nav nav-tabs" role="tablist">
								<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#activo" role="tab"><span class="hidden-sm-up"><i class="icon-folder-alt"></i></span> <span class="hidden-xs-down">Activos</span></a> </li>
